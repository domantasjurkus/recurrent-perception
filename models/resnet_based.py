...
class ResnetBased(nn.Module):
    def __init__(self, n_classes=4):
        ...
        # requires_grad = True meaning we're retraining the 1st layer
        # print(list(self.model.parameters())[0].requires_grad)
        
        # https://discuss.pytorch.org/t/insert-new-layer-in-the-middle-of-a-pre-trained-model/12414/6
        self.model.layer4[1].conv2 = nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
